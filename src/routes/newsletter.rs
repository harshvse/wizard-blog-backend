...
use crate::{domain::SubscriberEmail, email_client::EmailClient, routes::helper::error_chain_fmt, telemetry::spawn_blocking_with_tracing};
...
#[tracing::instrument(
    ...
    fields(
        ...
        email_text_content = %body.content.text,
        email_html_content = %body.content.html,
